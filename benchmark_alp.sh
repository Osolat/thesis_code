...
./alp_naive_500 n_attr 128 >> alp_result.txt &&
./alp_g_oe_500 n_attr 128 >> alp_result.txt &&
./alp_a_oe_500 n_attr 128 >> alp_result.txt &&
./alp_p_oe_500 n_attr 128  >> alp_result.txt &&
./alp_GAP_oe_500 n_attr 128 >> alp_result.txt &&
./alp_GAP_ok_500 n_attr 128 >> alp_result.txt &&
./alp_naive_100 n_attr 256 >> alp_result.txt &&
./alp_g_oe_100 n_attr 256 >> alp_result.txt &&
./alp_a_oe_100 n_attr 256  >> alp_result.txt &&
./alp_p_oe_100 n_attr 256  >> alp_result.txt &&
./alp_GAP_oe_100 n_attr 256 >> alp_result.txt &&
./alp_GAP_ok_100 n_attr 256 >> alp_result.txt &&
./alp_naive_10 n_attr 512 >> alp_result.txt &&
./alp_g_oe_10 n_attr 512 >> alp_result.txt &&
./alp_a_oe_10 n_attr 512 >> alp_result.txt &&
./alp_p_oe_10 n_attr 512 >> alp_result.txt &&
./alp_GAP_oe_10 n_attr 512 >> alp_result.txt &&
./alp_GAP_ok_10 n_attr 512 >> alp_result.txt &&
./alp_naive_2 n_attr 1024 >> alp_result.txt &&
./alp_g_oe_2 n_attr 1024 >> alp_result.txt &&
./alp_a_oe_2 n_attr 1024 >> alp_result.txt &&
./alp_p_oe_2 n_attr 1024 >> alp_result.txt &&
./alp_GAP_oe_2 n_attr 1024 >> alp_result.txt &&
./alp_GAP_ok_2 n_attr 1024 >> alp_result.txt 